...
## [0.1.0](https://github.com/devrandom-labs/nexus/releases/tag/nexus-framework-v0.1.0) - 2026-06-07
...
- *(framework)* migrate projection runner to SharedSubscription — PR2 of arc-subscription refactor ([#178](https://github.com/devrandom-labs/nexus/pull/178))

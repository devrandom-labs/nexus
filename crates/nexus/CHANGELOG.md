...
## [0.1.0](https://github.com/devrandom-labs/nexus/compare/nexus-v0.0.1...nexus-v0.1.0) - 2026-06-28

### Added

- *(kernel)* [**breaking**] Id::to_label returns ErrorId, seal arrayvec from public API (#208, PR 4/4) ([#234](https://github.com/devrandom-labs/nexus/pull/234))
...
- *(kernel)* seal arrayvec from public API — ErrorId + EventsIntoIter (#208, PR 1/4) ([#231](https://github.com/devrandom-labs/nexus/pull/231))
- *(kernel)* saga / process-manager primitive + SagaFixture ([#127](https://github.com/devrandom-labs/nexus/pull/127)) ([#201](https://github.com/devrandom-labs/nexus/pull/201))

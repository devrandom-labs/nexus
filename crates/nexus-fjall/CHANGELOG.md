...
## [0.1.0](https://github.com/devrandom-labs/nexus/releases/tag/nexus-fjall-v0.1.0) - 2026-07-02
...
- *(fjall)* craftsmanship + architecture pass — plan_run, Partitions, configurable AllIndex ([#270](https://github.com/devrandom-labs/nexus/pull/270)) ([#271](https://github.com/devrandom-labs/nexus/pull/271))
